            ...
            <div className="px-4 pt-1 pb-24">
              <div className="relative mt-4">
                <div className="flex justify-center mb-4" >
                  <Image src={dollarCoin} alt="dollar coin" className="w-12 h-12 object-cover" 
                  style={{ boxShadow: '0 0 30px rgba(255, 204, 0, 0.8), 0 0 50px rgba(255, 204, 0, 0.6)',
                    backgroundColor: 'transparent',
                    borderRadius: '50%'
                   }} />
                </div>
                <h1 className="text-2xl text-center mb-4">Earn more coins</h1>
                          ...
                          >
                            <div className="flex items-center">
                              ...
                              <div className="flex flex-col">
                                ...
                                <div className="flex items-center">
                                  <Image src={dollarCoin} alt="dollar coin" className="w-4 h-4 mr-1" />
